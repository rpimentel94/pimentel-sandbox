 ...
 *
 * @MigrateSource(
 *   id = "d8_paragraph_alter",
 *   source_provider = "htlf_migrate"
 * )
 */
class ParagraphAlter extends SqlBase {
  ...
  public function prepareRow(Row $row) {
    ...
    $row->setSourceProperty('bundle', "blog_posts");
    $row->setSourceProperty('type', "blog_posts");

    \Drupal::logger('my_module')->debug('<pre><code>' . print_r($row, TRUE) . '</code></pre>');
